const contractAddress = "0x214586D4Bf385bB54d9F38DDF741b60b4a4002cB"; //Replace with your own contract address
const chain = 'rinkeby'; // rinkeby or polygon

const welcome_h1 = "Welcome to the Alchemy Shores NFT Project";
const welcome_h2 = "Connect to MetaMask to Get Started";
const welcome_p = 'The Alchemy Shores NFT Project is a decentralized, open-source project that aims to demonstrate how to develope and launch your own NFT Collection. Follow step by step on the <a href="https://youtube.com/codestackr"  target="_blank" rel="noopener noreferrer">codeSTACKr</a> YouTube channel.';
